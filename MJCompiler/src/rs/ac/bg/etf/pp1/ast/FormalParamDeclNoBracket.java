...
public class FormalParamDeclNoBracket extends FormalParamDecl {

    private Type Type;
    private String iden;
    private ArrayOrNot ArrayOrNot;

    public FormalParamDeclNoBracket (Type Type, String iden, ArrayOrNot ArrayOrNot) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParamDeclNoBracket(\n");
