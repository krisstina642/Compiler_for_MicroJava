...
public class VarClasssDeclListt extends VarClassDeclList {

    private VarClassDecl VarClassDecl;
    private VarClassDeclList VarClassDeclList;

    public VarClasssDeclListt (VarClassDecl VarClassDecl, VarClassDeclList VarClassDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarClasssDeclListt(\n");
